...
export function ContextPane({ isCollapsed, onToggle, currentView, position = 'right', onPositionChange, onClose }) {
...
2. "command": The exact, valid PowerShell/CMD command string to execute the requested action. Use standard Windows commands (like 'mkdir', 'cd', 'ls', 'echo', etc.). If the user is just chatting and doesn't need a command, send an empty string "" for command.`
    ...
    if (currentView === 'terminal') {
        const paneContent = (_jsxs("aside", { className: `context-pane ${position === 'floating' ? 'floating-panel' : ''}`, style: { height: '100%', display: 'flex', flexDirection: 'column', margin: 0 }, children: [_jsxs("div", { className: "pane-header pane-handle", style: { paddingBottom: '14px', borderBottom: '1px solid rgba(33, 231, 255, 0.2)', marginBottom: '14px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', cursor: position === 'floating' ? 'move' : 'default' }, children: [_jsxs("h3", { style: { color: 'var(--cyan)', fontSize: '16px', fontWeight: 'bold', display: 'flex', alignItems: 'center', gap: '8px', margin: 0 }, children: [_jsx("svg", { width: "18", height: "18", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: _jsx("path", { d: "M12 2a10 10 0 1 0 10 10H12V2z" }) }), "Terminal AI"] }), _jsxs("div", { style: { display: 'flex', gap: '8px' }, children: [onPositionChange && (_jsxs(_Fragment, { children: [_jsx("button", { onClick: () => onPositionChange('floating'), style: { background: position === 'floating' ? 'var(--cyan-soft)' : 'transparent', border: '1px solid var(--cyan-soft)', color: 'var(--cyan)', cursor: 'pointer', padding: '4px 8px', borderRadius: '4px', fontSize: '12px' }, title: "Flutuar Tela", children: "\uD83E\uDE9F" }), _jsx("button", { onClick: () => onPositionChange(position === 'right' ? 'bottom' : 'right'), style: { background: 'transparent', border: '1px solid var(--cyan-soft)', color: 'var(--cyan)', cursor: 'pointer', padding: '4px 8px', borderRadius: '4px', fontSize: '12px' }, title: `Acoplar em ${position === 'right' ? 'Baixo' : 'Direita'}`, children: position === 'right' ? '⬇️' : '➡️' })] })), onClose && (_jsx("button", { onClick: onClose, style: { background: 'transparent', border: 'none', color: '#ff4c6a', cursor: 'pointer', padding: '4px' }, title: "Fechar Terminal AI", children: _jsxs("svg", { width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: [_jsx("line", { x1: "18", y1: "6", x2: "6", y2: "18" }), _jsx("line", { x1: "6", y1: "6", x2: "18", y2: "18" })] }) }))] })] }), !isCollapsed && (_jsxs("div", { style: { display: 'flex', flexDirection: 'column', height: 'calc(100% - 60px)' }, children: [_jsxs("div", { style: { flex: 1, overflowY: 'auto', padding: '16px', display: 'flex', flexDirection: 'column', gap: '16px' }, children: [messages.map(msg => (_jsxs("div", { className: msg.role === 'assistant' ? 'system-msg' : 'user-msg', children: [msg.role === 'assistant' && _jsx("span", { className: "ai-badge", style: { marginBottom: '6px' }, children: "AI" }), _jsx("p", { children: msg.content }), msg.command && (_jsxs("div", { style: { marginTop: '8px', padding: '6px', background: 'rgba(0,0,0,0.3)', borderRadius: '4px', fontFamily: 'monospace', fontSize: '11px', color: '#ffd60a' }, children: ["> ", msg.command] }))] }, msg.id))), isGenerating && (_jsxs("div", { style: { display: 'flex', alignItems: 'center', color: 'var(--text-secondary)' }, children: [_jsxs("svg", { className: "spin", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: [_jsx("line", { x1: "12", y1: "2", x2: "12", y2: "6" }), _jsx("line", { x1: "12", y1: "18", x2: "12", y2: "22" }), _jsx("line", { x1: "4.93", y1: "4.93", x2: "7.76", y2: "7.76" }), _jsx("line", { x1: "16.24", y1: "16.24", x2: "19.07", y2: "19.07" }), _jsx("line", { x1: "2", y1: "12", x2: "6", y2: "12" }), _jsx("line", { x1: "18", y1: "12", x2: "22", y2: "12" }), _jsx("line", { x1: "4.93", y1: "19.07", x2: "7.76", y2: "16.24" }), _jsx("line", { x1: "16.24", y1: "4.93", x2: "19.07", y2: "7.76" })] }), _jsx("span", { style: { marginLeft: '8px', fontSize: '12px' }, children: "Pensando..." })] })), _jsx("div", { ref: messagesEndRef })] }), _jsxs("div", { style: {
        ...
        if (position === 'floating') {
            return (_jsx(Rnd, { default: {
                    x: window.innerWidth / 2 - 175,
                    y: window.innerHeight / 2 - 250,
                    width: 350,
                    height: 500,
                }, minWidth: 280, minHeight: 300, bounds: "window", dragHandleClassName: "pane-handle", style: { zIndex: 1000 }, children: paneContent }));
        }
        return paneContent;
    }

...
const builtinProviders: ProviderConfig[] = ["OpenAI", "Anthropic", "Together AI", "DeepSeek", "Perplexity", "Fireworks"].map((name) => ({ id: createProviderId(name), name, kind: "builtin", defaultModel: "" }));
const runtimeInfo = {
